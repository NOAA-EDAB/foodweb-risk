...
Macrobenthos predicts condition? 
...
ggplot2::ggplot() +
  ggplot2::theme_bw() +
  ggplot2::geom_point(data=bsbcondprey, ggplot2::aes(x=scaleMacro, y=scaleCond), color="blue") +
  ggplot2::geom_smooth(data=bsbcondprey, ggplot2::aes(x=scaleMacro, y=scaleCond), method="lm", col="blue") +
  ggplot2::facet_grid(~factor(EPU, levels = c("MAB", "GB", "GOM")))

```

Megabenthos predicts condition? No. Some weighted combination?

```{r}

ggplot2::ggplot() +
  ggplot2::theme_bw() +
  ggplot2::geom_point(data=bsbcondprey, ggplot2::aes(x=scaleMega, y=scaleCond), color="red") +
